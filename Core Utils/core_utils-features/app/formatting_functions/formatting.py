...
class Formatter:
    ...
    def make_screen(frame):
        ...
        # Gumb za pokretanje formatiranja
        ...
        # Gumb za spremanje formatiranog sadržaja
    ...
    def format_text(format_option, frame):
        # Provjera je li datoteka odabrana
        ...
        try:
            ...
            # Formatiranje prema odabranoj opciji
