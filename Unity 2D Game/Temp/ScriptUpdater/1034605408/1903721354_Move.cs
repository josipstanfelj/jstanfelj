...
public class Move : MonoBehaviour
{
    ...
    private void ThrowKnife()
    {
        ...
        // Provjera da li no� ima Rigidbody2D
        if (knifeRb != null)
        {
            // Smanjenje gravitacije no�a
            knifeRb.gravityScale = 0.1f;

            // Postavljanje smjera no�a prema smjeru igra�a
        ...
        // Uni�tavanje no�a nakon 7 sekundi
        Destroy(knife, 7f);
    }
